...
// 	public AIPops(int dimensions){
// 		thisdimensions = dimensions;
// 	}

// 	public Dictionary<Coords, Hedgehog> GetResultingBoardState(Move move, Dictionary<Coords, Hedgehog> startingBoardState){
